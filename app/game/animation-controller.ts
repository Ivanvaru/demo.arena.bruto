...
export const MOTIONS:Record<MotionName,MotionDefinition>={
  ...
  punch:{duration:1250,contact:700,tracks:[
    ...
    track(".bone-upper-arm-izq",[k(0,{}),k(.18,{r:11}),k(.34,{r:8}),k(.46,{r:-18}),k(.53,{r:-48}),k(.56,{x:2,y:-1,r:-72}),k(.64,{x:2,y:-1,r:-72}),k(.74,{r:-38}),k(.86,{r:-9}),k(1,{})]),
    track(".bone-forearm-izq",[k(0,{}),k(.18,{r:12}),k(.38,{r:24}),k(.48,{r:18}),k(.53,{r:9}),k(.56,{r:4}),k(.64,{r:4}),k(.74,{r:19}),k(.86,{r:7}),k(1,{})]),
