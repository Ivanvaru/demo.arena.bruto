...
export const MOTIONS:Record<MotionName,MotionDefinition>={
  ...
  punch:{duration:1250,contact:700,tracks:[
    ...
    track("root",[k(0,{}),k(.08,{x:-4,y:3,r:.6}),k(.18,{x:-9,y:7,r:1.5}),k(.3,{advance:.18,y:-20,r:-1}),k(.43,{advance:.58,y:-43,r:-1.8}),k(.56,{advance:1.12,y:-28,r:-2.8}),k(.62,{advance:1.1,y:-26,r:-2.3}),k(.74,{advance:.8,y:-24,r:.7}),k(.86,{advance:.3,y:-17,r:1.1}),k(.94,{advance:.04,y:4,r:-.5}),k(1,{})]),
    ...
    track(".bone-upper-arm-izq",[k(0,{}),k(.18,{y:-2,r:8}),k(.34,{y:-5,r:-6}),k(.46,{x:1,y:-9,r:-31}),k(.53,{x:3,y:-12,r:-61}),k(.56,{x:5,y:-14,r:-80}),k(.64,{x:5,y:-14,r:-80}),k(.74,{x:2,y:-7,r:-42}),k(.86,{y:-2,r:-10}),k(1,{})]),
    track(".bone-forearm-izq",[k(0,{}),k(.18,{r:9}),k(.38,{r:19}),k(.48,{r:16}),k(.53,{r:13}),k(.56,{x:2,y:-2,r:12}),k(.64,{x:2,y:-2,r:12}),k(.74,{r:20}),k(.86,{r:7}),k(1,{})]),
    track(".bone-hand-izq",[k(0,{}),k(.46,{y:-1,r:-2}),k(.56,{x:3,y:-4,r:-7,sx:1.045,sy:1.045}),k(.64,{x:3,y:-4,r:-7,sx:1.045,sy:1.045}),k(.74,{x:1,y:-2,r:-3,sx:1.015,sy:1.015}),k(1,{})]),
