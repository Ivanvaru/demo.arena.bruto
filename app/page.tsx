...
import {DEFAULT_IDENTITY,loadIdentity,saveIdentity,SKIN_TONES,DEFAULT_SKIN_TONE_ID,EYE_STYLES,EYE_COLORS,EYEBROW_STYLES,CLASS_CLOTHING,CLASS_BODY_TEXTURE,DEFAULT_BODY_TEXTURE,FACE_PLACEHOLDER_GEOMETRY,resolveFaceAppearance,type PlayerIdentity,type FaceAppearance} from "./game/character";
  ...
  return <div className={`life-card card-${side}`} aria-label={`${fighter.name}: ${fighter.hp} de ${fighter.maxHp} puntos de vida`}>
    <svg viewBox="0 0 1600 300" role="img" aria-hidden="true">
      ...
      <g filter={`url(#shadow-${suffix})`}>
        ...
        <image href={CLASS_BODY_TEXTURE[fighter.className]??DEFAULT_BODY_TEXTURE} x="26" y="27" width="208" height="208" preserveAspectRatio="xMidYMin slice" clipPath={`url(#portrait-${suffix})`}/>
...
export default function Home(){
  ...
  const playerBodyTexture=CLASS_BODY_TEXTURE[playerClass]??DEFAULT_BODY_TEXTURE;
