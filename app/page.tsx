...
function TournamentBracketLines(){
  return <svg className="bracket-lines" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
    <g>
      <path d="M13.63 12.5H16V25H18.37M13.63 37.5H16V25M13.63 62.5H16V75H18.37M13.63 87.5H16V75M28.47 25H30.3V50H32.2M28.47 75H30.3V50M42.4 50H44.9" />
      <path d="M86.37 12.5H84V25H81.63M86.37 37.5H84V25M86.37 62.5H84V75H81.63M86.37 87.5H84V75M71.53 25H69.7V50H67.8M71.53 75H69.7V50M57.6 50H55.1" />
    </g>
  </svg>;
}
